...
<!-- Mirrored from cartzilla.createx.studio/home-electronics-store.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Aug 2022 18:11:55 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>Manuel Pérez | Proyecto ECommerce</title>
    <!-- Viewport-->
  ...
  <body class="handheld-toolbar-enabled">
      ...
      <header class="shadow-sm">
        ...
        <div class="topbar topbar-dark bg-dark">
          <div class="container">
            <div class="topbar-text text-light mb-0">
                <?php if (!empty($user)): ?>
                    Bienvenido, <strong><?php echo htmlspecialchars($user, ENT_QUOTES, 'UTF-8'); ?></strong>
                <?php else: ?>
                    Bienvenido, invitado
                <?php endif; ?>
            </div>
            <div class="d-none d-md-block ms-3 text-nowrap"><a class="topbar-link d-none d-md-inline-block" href="../articulo/index.php">
                <i class="ci-heart mt-n1"></i>Catalogo</a>
                <?php if ($user_type === 'buyer'): ?>
                  <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="../factura/index.php?action=viewbuyer&id=<?= $_SESSION['user_id'] ?? null ?>">
                  <i class="ci-compare mt-n1"></i>Historial</a>
                <?php endif; ?>
                <?php if ($user_type === 'seller'): ?>
                  <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="../factura/index.php?action=viewseller&id=<?= $_SESSION['user_id'] ?? null ?>">
                  <i class="ci-compare mt-n1"></i>Historial</a>
                <?php endif; ?>
                <?php if ($user_type === 'seller'): ?>
                <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="../disputa/index.php?action=viewseller&id=<?= $_SESSION['user_id'] ?? null ?>">
                <i class="ci-compare mt-n1"></i>Disputas</a>
                <?php endif; ?>
                <?php if ($user_type === 'buyer'): ?>
                <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="../disputa/index.php?action=viewbuyer&id=<?= $_SESSION['user_id'] ?? null ?>">
                <i class="ci-compare mt-n1"></i>Disputas</a>
                <?php endif; ?>
                <?php if ($user_type === 'admin'): ?>
                <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block" href="../disputa/index.php?action=viewadmin">
                <i class="ci-compare mt-n1"></i>Disputas</a>
                <?php endif; ?>
                <?php if ($user_type === 'buyer'): ?>
                    <a class="topbar-link ms-3 ps-3 border-start border-light d-none d-md-inline-block"
                       href="../review/index.php?action=viewbuyer&id=<?= htmlspecialchars($userid ?? '', ENT_QUOTES, 'UTF-8') ?>">
                        <i class="ci-compare mt-n1"></i>Reseñas
                    </a>
                <?php endif; ?>
                <a class="topbar-link ms-3 border-start border-light ps-3 d-none d-md-inline-block" href="../user/index.php?action=logout"><i class="ci-location mt-n1">   
                </i>Cerrar Sesion</a>
            </div>
          </div>
        </div>
...
<!-- Mirrored from cartzilla.createx.studio/home-electronics-store.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Aug 2022 18:13:26 GMT -->
</html>